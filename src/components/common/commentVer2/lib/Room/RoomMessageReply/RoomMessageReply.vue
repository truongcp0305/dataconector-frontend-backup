            ...
            <div class="vac-reply-box">
                <div class="vac-reply-info">
                    ...
                    <div class="vac-reply-content">
                        ...
                        <!-- <p style="height: 40px;overflow-y: auto;">
...
export default {
    ...
    computed: {
        firstFile() {
            return this.messageReply.files?.length
                ? this.messageReply.files[0]
                : {};
        },
        isImage() {
...
<style scoped>
.vac-reply-content >>> .vac-format-message-wrapper {
    height: 40px;
    overflow-y: auto;
}
</style>
