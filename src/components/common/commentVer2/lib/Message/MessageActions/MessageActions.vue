    ...
    <div class="vac-message-actions-wrapper">
        ...
        >
            <transition-group name="vac-slide-left" tag="span">
                ...
                <div
                    ...
                    @click="openOptions"
                >
                    <i class="mdi mdi-chevron-down white--text" style="line-height: 15px;"></i> 
                </div>
        ...
        >
            <div
                ...
                :class="{ 'vac-menu-left': message.senderId !== currentUserId }"
            >
                <div class="vac-menu-list">
                    <div
                        ...
                        :key="action.name"
                    >
                        <template v-if="action.name != 'deleteMessage'">
                            <div
                                class="vac-menu-item"
    ...
    methods: {
        openOptions() {
            ...
            setTimeout(() => {
                ...
                const actionIconTop =
                    this.$refs.actionIcon.getBoundingClientRect().top;
                const roomFooterTop =
                    this.roomFooterRef.getBoundingClientRect().top;
