...
export const cssThemeVars = ({
    ...
    return {
        ...
        '--chat-message-bg-color-scroll-counter':
            message.backgroundScrollCounter,
        ...
        '--chat-message-bg-color-reaction-hover':
            message.backgroundReactionHover,
        ...
        '--chat-message-border-style-reaction-me':
            message.borderStyleReactionMe,
        ...
        '--chat-message-color-reaction-counter-me':
            message.colorReactionCounterMe,
        ...
        '--chat-message-bg-color-audio-progress':
            message.backgroundAudioProgress,
