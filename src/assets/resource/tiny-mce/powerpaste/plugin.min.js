...
!(function () {
    ...
    h('17', Array),
        ...
        g('o', ['17'], function (a) {
            var b = function () {},
                ...
                g = function (b) {
                    ...
                    return function () {
                        for (
                            var d = new a(arguments.length), e = 0;
                            e < d.length;
                            e++
                        )
                            d[e] = arguments[e];
        ...
        g('1a', ['2', 'o'], function (a, b) {
            var c = function (a) {
                ...
                e = function (a) {
                    ...
                    return b ? d(c(b[1]), c(b[2]), c(b[3])) : d(0, 0, 0);
                },
                f = function () {
                    var b = [a.majorVersion, a.minorVersion].join('.');
                    return e(b.split('.').slice(0, 3).join('.'));
                };
            return { getTinymceVersion: f };
        }),
        g('c', ['g', 'o', '1a'], function (a, b, c) {
            return function (d) {
                var e = function (a) {
                        var b = a.toLowerCase(),
                            c = {
                        ...
                        return c.hasOwnProperty(b) ? c[b] : 'dat';
                    },
                    f = function () {
                        var a = c.getTinymceVersion();
                        return 4 === a.major() && a.minor() < 6;
                    },
                    g = function (a, c) {
                        return b.constant(f() ? a : a + '.' + e(c));
                    },
                    h = function (c) {
                        a.each(c, function (a) {
                            a.fold(function (a, c, e, f) {
                                d.editorUpload.blobCache.add({
                                    id: b.constant(a),
                                    name: b.constant(a),
                                    filename: g(a, c.type),
                                    blob: b.constant(c),
                                    base64: b.constant(f.result.split(',')[1]),
                                    blobUri: b.constant(e),
                                    uri: b.constant(null),
                                });
                            }, b.noop);
                        });
                    ...
                    j = function (c) {
                        a.each(c, function (c) {
                            c.fold(function (b, c, e, f) {
                                a.each(
                                    d.dom.select('img[src="' + e + '"]'),
                                    function (a) {
                                        d.dom.setAttrib(a, 'src', f.result);
                                    },
                                );
                            }, b.noop);
                        });
        ...
        g('d', ['2'], function (a) {
            var b = function () {
                ...
                e = {
                    ...
                    'cement.dialog.flash.title':
                        'Additional step needed to paste images',
        ...
        h('1m', document),
        g('k', ['o', '1k', '1l', '1m'], function (a, b, c, d) {
            var e = function (a, b) {
                    var e = b || d,
        ...
        g('3v', ['g', '1i', 'o', '17'], function (a, b, c, d) {
            var e = function (e, f) {
                var g = function () {
                        for (
                            var b = new d(arguments.length), f = 0;
                            f < b.length;
                            f++
                        )
                            b[f] = arguments[f];
        ...
        g('3w', ['g', '1i', 'o', 'p', '6a', '19'], function (a, b, c, d, e, f) {
            return function (g, h) {
                var i = g.concat(h);
                if (0 === i.length)
        ...
        h('3h', isNaN),
        h('3i', parseFloat),
        g('2e', ['3f', '3g', '3h', '3i'], function (a, b, c, d) {
            var e = function (a) {
                    return function (b, c) {
                        var d = typeof c;
                        if (d !== a)
        ...
        g('4x', [], function () {
            var a = function (a, b) {
                ...
                if ('object' === c) {
                    ...
                    return (
                        b.major > d.major ||
                        (b.major === d.major && b.minor >= d.minor)
                    );
                }
                throw 'invalid spec';
            };
        ...
        g('2p', ['1j', 'g', 'p', 'k', '1k', '1m'], function (a, b, c, d, e, f) {
            var g = 0,
                h = 1,
                i = 2,
                j = 3,
                ...
                q = function (a, b) {
                    ...
                    return o(e)
                        ? c.none()
                        : c.from(e.querySelector(a)).map(d.fromDom);
                };
            return { all: p, is: n, one: q };
        }),
        g('3y', ['g', '31', '6d', 'o', '2p'], function (a, b, c, d, e) {
            var f = function (a, b) {
                    return a.dom() === b.dom();
                },
                g = function (a, b) {
        ...
        g(
            ...
            function (a, b, c, d, e, f, g, h) {
                var i = function (a) {
                    ...
                    n = function (b, d) {
                        for (
                            var e = a.isFunction(d) ? d : c.constant(!1),
                                f = b.dom(),
                                g = [];
        ...
        g('2h', ['g', 'k', '3q', '1m'], function (a, b, c, d) {
            var e = function (a, e) {
                    var f = e || d,
        ...
        g('5s', ['66', 'k', '10', '1m'], function (a, b, c, d) {
            var e = function (a) {
                ...
                var h = function (a) {
                    ...
                    i = function (c) {
                        for (var i = 0; i < c.undoManager.data.length; i++) {
                            ...
                            a.each(l, h),
                                (c.undoManager.data[i].content =
                                    k.dom().innerHTML);
                        }
                    },
                    j = function (a, b, c) {
                        for (var d = 0; d < a.undoManager.data.length; d++)
                            a.undoManager.data[d].content = a.undoManager.data[
                                d
                            ].content
                                .split(b.objurl())
                                .join(c.location);
        ...
        g('1d', ['1i', '2k', 'p', '2l'], function (a, b, c, d) {
        ...
        g('1r', ['1h', '17'], function (a, b) {
            var c = function (a, b) {
                ...
                e = function (a) {
                    return function () {
                        for (
                            var c = new b(arguments.length), d = 0;
                            d < c.length;
                            d++
                        )
                            c[d] = arguments[d];
                        ...
                        for (var e = {}, f = 0; f < c.length; f++) {
                            var g = c[f];
                            for (var h in g)
                                g.hasOwnProperty(h) && (e[h] = a(e[h], g[h]));
                        }
                        return e;
                    };
                },
        ...
        g('1s', ['1h', 'g', '1i', '17'], function (a, b, c, d) {
            var e = function (e) {
                ...
                return (
                    b.each(e, function (b, g) {
                        ...
                        var i = h[0],
                            j = b[i];
                        if (void 0 !== f[i])
                            throw 'duplicate key detected:' + i;
                        if ('cata' === i)
        ...
        g('41', ['g', '2g', '3t', '17'], function (a, b, c, d) {
            var e = function (c, d) {
                    a.each(d, function (a) {
                        b.add(c, a);
                    });
        ...
        g('26', ['p', '2j', '2p', '2q'], function (a, b, c, d) {
            var e = function (c) {
                ...
                var n = h.immutable('image', 'blobInfo'),
                    ...
                    u = function (a, b) {
                        return a.get(b).fold(
                            function () {
                                return e.error(
                                    'Internal error with blob cache',
                                );
                            },
                            function (c) {
        ...
        g('2r', ['1h', 'g', '42', '2l', '11'], function (a, b, c, d, e) {
            var f = d.immutable('message', 'status', 'contents'),
                ...
                j = function (a, b, d) {
                    ...
                    return (
                        e.append(a, b, d),
                        { data: e, contentType: !1, processData: !1 }
                    );
                };
        ...
        g('43', ['1r', '6f', '44'], function (a, b, c) {
            var d = function (c, d, e, f) {
                    b.ajax(
                        c,
                        d,
                        e,
                        a.merge({ dataType: 'text', type: 'GET' }, f),
                    );
                },
        ...
        g('6h', ['11', '7b', '7c', '7d'], function (a, b, c, d) {
            var e = function (e, f) {
                var g = { strictMode: !0 },
                    h = b.parse(e, g),
                    i = b.parse(f, g),
                        ...
                        var k = function (a) {
                            ...
                            l = function (c) {
                                a.isString(c)
                                    ...
                                    : (e.error(
                                          'Image upload result was not a string',
                                      ),
                                      k(''));
                            },
            ...
            var d = 'startElement',
                ...
                m = function (a, c, j) {
                    ...
                    switch (a.nodeType) {
                        ...
                        default:
                            b.log(
                                'WARNING: Unsupported node type encountered: ' +
                                    a.nodeType,
                            );
                    }
                    var q = function () {
        ...
        g('2w', ['47', '46'], function (a, b) {
            ...
            return a.createFilter(function (a, c) {
                var g = function () {
                    f ||
                        (a.emit(b.createStartElement('P', {}, {}, a.document)),
                        (f = !0));
                };
                switch (c.type()) {
                    case b.TEXT_TYPE:
                    ...
                    case b.END_ELEMENT_TYPE:
                        f && (d(c) || c === b.FINISHED)
                            ? (a.emit(b.createEndElement('P', a.document)),
                              (f = !1))
                            : 'BR' === c.tag() && a.emit(c);
                        break;
                    case b.START_ELEMENT_TYPE:
                        'BR' === c.tag()
                            ? (c.filterAttributes(e),
                              c.filterStyles(e),
                              a.emit(c))
                            : 'IMG' === c.tag() &&
                              c.getAttribute('alt') &&
        ...
        g('48', ['46'], function (a) {
            var b = function () {
                    ...
                    return (
                        'Ignore' === a.token(b.firstChild).getStyle('mso-list')
                    );
                },
                c = b(),
                d = function (a) {
        ...
        g('49', ['46', '4c', '1n'], function (a, b, c) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            return (
                                ...
                                /^[\u00A0\s]/.test(
                                    f.nextSibling.firstChild.value,
                                ) &&
                    ...
                    var a,
                        ...
                        c = function (c, d, f, g) {
                            ...
                            return g && /^([0-9]+\.)+[0-9]+\.?$/.test(g.text)
                                ...
                                : ((i =
                                      b ||
                                      parseInt(h(f, d.getAttribute('class')))),
            ...
            return {
                isListWithoutCommentsOrStyles: d,
                indentGuesser: i,
                styles: j,
            };
        }),
        g('4a', ['46', '4c'], function (a, b) {
                        ...
                        if (g) {
                            ...
                            if (((g = d(g, b)), i == b)) m(), n(f, g, l);
                                ...
                                for (
                                    ...
                                    'P' !== h[h.length - 1] &&
                                    (c.emit(
                                        a.createEndElement(h[h.length - 1], e),
                                    ),
                                    (h[h.length - 1] = 'P'));
                                    i < b;
        ...
        g('4b', ['48', '46', '49', '4c', '1n'], function (a, b, c, d, e) {
            var f = function (a, b) {
                    e.log(
                        'Unexpected token in list conversion: ' + b.toString(),
                    ),
                        a.rollback();
                },
                g = function (a, b, c) {
                ...
                i = function (d, e, f) {
                    ...
                    (!a.supportsCustomStyles &&
                        c.isListWithoutCommentsOrStyles(f, e)) ||
                    a.hasMsoListStyle(f)
                ...
                j = function (d, e, f) {
                    ...
                    if (
                        ...
                        h && h[1]
                            ? ((e.itemLevel =
                                  parseInt(h[1], 10) + e.styleLevelAdjust),
                              e.nextFilter === j
                                  ? d.emitDeferred()
                                  : d.dropDeferred(),
                              (e.nextFilter = l),
                ...
                l = function (a, c, d) {
                    if (
                        ...
                        if (c.commentMode)
                            (c.nextFilter = m), c.nextFilter(a, c, d);
                        else {
                        ...
                        (c.commentMode || d.type() !== b.COMMENT_TYPE) &&
                            f(a, d);
                },
                m = function (c, d, e) {
                    e.type() === b.TEXT_TYPE
            ...
            var d = [],
                ...
                i = function (a, b) {
                    if (
                        (d.push(b),
                        (e = e || []),
                        b.type() === c.START_ELEMENT_TYPE)
                    )
                        e.push(b);
                    else if (
                        b.type() === c.END_ELEMENT_TYPE &&
                        (e.pop(), 0 === e.length)
                    )
                        return void h(a, b);
                };
        ...
        g('4m', ['47', '48', '46'], function (a, b, c) {
            var d = function (a) {
                    return (
                        !b.hasNoAttributes(a) &&
                        !/^OLE_LINK/.test(a.getAttribute('name'))
                    );
                },
                e = [];
            return a.createFilter(function (a, b) {
        ...
        g('4q', ['47'], function (a) {
            return a.createFilter(function (a, b) {
                (b.tag && /^([OVWXP]|U[0-9]+|ST[0-9]+):/.test(b.tag())) ||
                    a.emit(b);
            });
        }),
        g('4r', ['47'], function (a) {
        ...
        g('f', ['1o', 'q', '1p', '1q', '12'], function (a, b, c, d, e) {
            return function (f, g) {
                var h = function (h) {
                    var i = f.settings.powerpaste_word_import || b.officeStyles,
                        j = f.settings.powerpaste_html_import || b.htmlStyles,
                        k = d.isWordContent(h) ? i : j,
                        l = function (b) {
                            var e = { content: h };
                            ...
                            var g = c.create(b, b, !0),
                                i = d.filter(e.content, g, f.getDoc());
                            f.fire('PastePostProcess', {
                                node: i,
                                internal: !1,
                            }),
                        ...
                        n = function () {
                            var a,
                                b = g('cement.dialog.paste.clean'),
                                c = g('cement.dialog.paste.merge'),
                                d = function () {
                                    a.close(), l('clean');
                                },
                                h = function () {
                                ...
                                i = [
                                    { text: b, ariaLabel: b, onclick: d },
                                    { text: c, ariaLabel: c, onclick: h },
                                ],
                                j = {
                                    title: g('cement.dialog.paste.title'),
                                    spacing: 10,
                                    padding: 10,
                                    items: [
                                        {
        ...
        g(
            ...
            function (a, b, c, d, e, f, g, h) {
                var i = c.detect(),
                    ...
                    m = function (a) {
                        return (
                            a.raw().target.files || a.raw().dataTransfer.files
                        );
                    },
                    n = function (b) {
                ...
                return function (i, j, k, l) {
                    ...
                    var o = function (a) {
                        ...
                        u = function (a) {
                            c.multiple(a).get(function (a) {
                                ...
                                i.insertContent(b, {
                                    merge:
                                        i.settings.paste_merge_formats !== !1,
                                }),
                                    l.uploadImages(a);
                            });
                        };
                    i.on('drop', function (a) {
                        if (!m) {
                            if (
                                h.dom.RangeUtils &&
                                h.dom.RangeUtils.getCaretRangeFromPoint
                            ) {
                            ...
                            var c = s(a);
                            if (c.length > 0)
                                return u(c), void a.preventDefault();
        ...
        g('50', ['51', '34', '21', '2l'], function (a, b, c, d) {
            ...
            function (a, b, c, d, e, f, g, h) {
                return function (i, j) {
                    var k = g.create({
                        ...
                        l = e.tap(function (d) {
                            h.willBlock() &&
                                (l.control.block(), d.preventDefault());
                            ...
                            var f = c.map(e.steps(), function (a) {
                                ...
                                g = a.run(f, e.input());
                            g.get(function (a) {
                                var c = a.bundle().isInternal().getOr(!1);
                                b.cata(
                                    a.response(),
                                    function (a) {
                                        k.trigger.error(a);
        ...
        g('54', ['6e', 'i', 'n', '2k', 'p'], function (a, b, c, d, e) {
            var f = function (a) {
        ...
        g('38', ['54', 'n', 'o', 'p'], function (a, b, c, d) {
            var e = function () {
                    var c = d.none(),
                        e = function (b) {
                            c = a.convert(b);
        ...
        h('55', RegExp),
        g('39', ['p', '2a', '55'], function (a, b, c) {
            var d = function (a) {
                    return (
                        void 0 !== a && void 0 !== a.types && null !== a.types
                    );
                },
                e = function (a, c) {
        ...
        g(
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                var p = i.immutable('blob', 'image'),
                    ...
                    s = function (a) {
                        return (
                            0 === a.indexOf('data:') && a.indexOf('base64') > -1
                        );
                    },
                    t = function (a) {
        ...
        g('59', ['50', '51', '34', 'n', '1l'], function (a, b, c, d, e) {
            var f = function (d) {
                    var f = function (f, g) {
                ...
                return function (j, k) {
                    var l = k.translations,
                        ...
                        n = function (b, c) {
                            ...
                            var p = f.fromTag('p'),
                                q = g.fromHtml(
                                    l('cement.dialog.paste.instructions'),
                                );
        ...
        g('3b', ['50', '51', '59', '5a', '34'], function (a, b, c, d, e) {
            var f = function (f, g) {
                    var h = d(f, g);
                    return function (d, f) {
                        var g = f.bundle(),
        ...
        g('7w', ['31', 'o', 'k', '1m'], function (a, b, c, d) {
            var e = function (a) {
        ...
        g('7h', ['p', '7w', '11', '1m'], function (a, b, c, d) {
            var e = function (d) {
                return b.find(
                    d,
                    a.some(function (a) {
        ...
        g(
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
                var n = function (b, c, d) {
                    ...
                    t = function (a, b) {
                        return i.isSupported(a)
                            ? a.style.getPropertyValue(b)
                            : '';
                    },
                    u = function (a, b) {
                        var c = a.dom(),
            ...
            function (a, b, c, d, e, f, g, h) {
                var i = function (a) {
                    ...
                    j = function (b, e, f) {
                        for (
                            var h = b.dom(),
                                i = a.isFunction(f) ? f : c.constant(!1);
                            h.parentNode;
        ...
        g('7i', ['1h', 'g', 'o', 'p', 'j', '2g'], function (a, b, c, d, e, f) {
            var g = function (b, c) {
                    var d = c.style;
                    if (
                        e.has(b, 'width') &&
        ...
        h('8y', CSSRule),
        g('8h', ['g', '2l', '8y'], function (a, b, c) {
            var d = b.immutable('selector', 'style', 'raw'),
                e = function (a) {
                    var b = a.selectorText,
                        c = a.style.cssText;
                    if (void 0 === c)
                        throw 'WARNING: Browser does not support cssText property';
                    return d(b, c, a.style);
                },
                f = function (b) {
                    var d = b.cssRules;
                    return a.bind(d, function (a) {
                        return a.type === c.IMPORT_RULE
                            ? f(a.styleSheet)
                            : a.type === c.STYLE_RULE
                            ? [e(a)]
                            : [];
            ...
            a('8i', [], function () {
                ...
                return (
                    'undefined' != typeof exports &&
                        ((exports.calculate = a.calculate),
                        (exports.compare = a.compare)),
                    a
                );
            });
        })(
        ...
        g(
            '7x',
            ['g', '2l', 'j', '5n', '2j', '11', '8g', '8h', '8i'],
            function (a, b, c, d, e, f, g, h, i) {
                var j = b.immutable('selector', 'raw'),
                    k = function (b, c) {
                        var d = {};
                        return (
                            a.each(b, function (e) {
                    ...
                    l = function (b, f) {
                        var g = a.bind(f, function (c) {
                            var f = e.descendants(b, c.selector());
                            return (
                                a.each(f, function (a) {
                                    var b = k(c.raw(), a);
                                    d.setAll(a, b);
                    ...
                    m = function (b, c) {
                        var d = function (a) {
                            ...
                            f = function (b) {
                                var c = b.selector().split(',');
                                return a.map(c, function (a) {
                                    var c = a.trim();
                                    return j(c, b.raw());
                                });
                            },
                            g = a.bind(a.filter(b, d), f),
                            h = a.filter(b, e),
                            k = h.concat(g);
                        k
                            .sort(function (a, b) {
                                return i.compare(a.selector(), b.selector());
                            })
                            .reverse(),
                            l(c, k);
                    },
                    n = function (a, b, c) {
                        var d = g.stylesheets(a),
                            e = h.extractAll(d).map(function (a) {
                                var b = a.selector(),
                                    d = c.hasOwnProperty(b) ? c[b] : b;
                                return j(d, a.raw());
                            });
                        m(e, b);
                    },
                    o = function (b, c, d) {
                        var e = g.stylesheets(b),
                            i = h.extractAll(e),
                            j = function (a) {
                                return f.startsWith(a.selector(), d);
                            },
                            k = a.filter(i, j);
                        m(k, c);
                    };
                return { inlineStyles: n, inlinePrefixedStyles: o };
            },
        ),
        g('7j', ['7x'], function (a) {
            var b = function (b, c, d) {
            ...
            return { inlineStyles: b, inlinePrefixedStyles: c };
        }),
        g(
            '6l',
            ['7i', 'g', 'o', 'j', 'y', '5n', '24', '2j', '3q', '7j'],
            function (a, b, c, d, e, f, g, h, i, j) {
                var k = { p: 'p, li[data-converted-paragraph]' },
                    l = function (b, c, d, e, f) {
                        var g = h.descendants(c, 'img');
                        o(c), a.insertRtfCorrelation(d, g, e);
                        var i = f.mergeInline() ? j.inlineStyles : m;
                        i(b, c, k), n(c);
                    },
                    m = c.noop,
                    n = function (a) {
                        var c = h.descendants(
                            a,
                            'li[data-converted-paragraph]',
                        );
                        b.each(c, function (a) {
                            d.remove(a, 'data-converted-paragraph');
                        });
                        var e = h.descendants(a, 'li');
                        b.each(e, function (a) {
        ...
        g('67', ['77', '5s'], function (a, b) {
            var c = function (c, d) {
                if (!b.inBody(c))
                    throw 'Internal error: attempted to write to an iframe that is not in the DOM';
                var e = a.doc(c),
                    f = e.dom();
                f.open('text/html', 'replace'), f.writeln(d), f.close();
            };
            return { write: c };
        }),
        g('2d', ['o', 'k'], function (a, b) {
        ...
        g(
            '5b',
            ['50', '51', '6k', '6l', '34', 'o', '6m', 'k', '2h', '6n', '1m'],
            function (a, b, c, d, e, f, g, h, i, j, k) {
                var l = 'data-textbox-image',
                    ...
                    r = function (a) {
                        var b = a.indexOf('<html'),
                            c = a.indexOf('</html>');
                        return b > -1 && c > -1
                            ? a.substr(b, c + '</html>'.length)
                            : a;
                    },
                    s = function (c, d, f) {
                        var g = r(c.data()),
                            h = n(g);
                        return f.cleanDocument(h, d).fold(
                            function () {
                                return a.pure({
                                    response: e.error(
                                        'errors.paste.word.notready',
                                    ),
                                    bundle: b.nu({}),
                                });
                            },
                            function (a) {
                                return m(a) ? q() : p(h, d, a);
                            },
                        );
                    };
                return { handle: s };
        ...
        g('5c', ['50', '51', '58', 'g', 'i'], function (a, b, c, d, e) {
            var f = function (f) {
                    ...
                    var b = function (b) {
                        return a(
                            function (a) {
                                return (
                                    0 ===
                                    b.toLowerCase().indexOf(a.toLowerCase())
                                );
                            },
                            function (a) {
        ...
        g('8j', ['g', '1i', 'o', 'j'], function (a, b, c, d) {
            var e = function (b, c) {
                    var d = {};
                    return (
        ...
        g('8k', ['g', '1i', 'j', '5n', '11'], function (a, b, c, d, e) {
            var f = function (b) {
                    var c = {},
        ...
        g('80', ['8j', '8k', 'o', 'k'], function (a, b, c, d) {
            var e = ['mso-list'],
                f = function (a, c) {
                    var d = b.scan(a, e, c),
                        f = b.filter(a, c);
        ...
        g('90', ['8k', '7p', 'o', 'j', '5n', 'k'], function (a, b, c, d, e, f) {
            var g = function (a, b) {
                    ...
                    j = function (a, b) {
                        var c = i(a),
                            e = h(
                                c.state(),
                                b,
                                b.type ? { 'list-style-type': b.type } : {},
                            );
                        return d.result(
                            e.state(),
                            c.result().concat(e.result()),
                        );
                    },
                    k = function (h, i, k) {
                        var l = {},
                            ...
                            q = p
                                ...
                                .map(function (b) {
                                    return (
                                        a.styleDom(i.getNode(), g.constant(!0)),
                                        [g.constant(i)]
                                    );
                                })
                                .getOr([]);
        ...
        h('8r', parseInt),
        g('94', ['g', '1r', '3h', '8r'], function (a, b, c, d) {
            var e = [
                    {
                        regex: /^\(?[dc][\.\)]$/,
                        type: { tag: 'OL', type: 'lower-alpha' },
        ...
        g('7n', ['6s', '83', '84', '85'], function (a, b, c, d) {
            var e = a.transformer({
                tags: [
                    {
        ...
        g('86', ['g', 'j', '6n', '10', '6t'], function (a, b, c, d, e) {
            var f = function (a) {
                    return 'img' !== d.name(a);
                },
                g = function (a) {
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l) {
                var m = b.unwrapper({
                        tags: [
                            {
                                name: l.pattern(
                                    /^([OVWXP]|U[0-9]+|ST[0-9]+):/i,
                                ),
                            },
                        ],
                    }),
                    n = [b.pipeline([c.filter])],
                    o = b.removal({
                        attributes: [
                            { name: l.pattern(/^v:/) },
                            {
                                name: l.exact('href'),
                                value: l.contains('#_toc'),
                            },
                            {
                                name: l.exact('href'),
                                value: l.contains('#_mso'),
                            },
                            { name: l.pattern(/^xmlns(:|$)/) },
                            { name: l.exact('type'), condition: d.isList },
                        ],
                    }),
                    p = b.removal({
                        attributes: [
                    ...
                    q = b.removal({
                        tags: [
                            ...
                            { name: l.exact('meta') },
                            { name: l.exact('link') },
                            { name: l.exact('style'), condition: d.isEmpty },
                        ],
                        attributes: [
                            { name: l.starts('on') },
                            { name: l.exact('"') },
                            { name: l.exact('lang') },
                            { name: l.exact('language') },
                        ],
                        styles: [
                            { name: l.all(), value: l.pattern(/OLE_LINK/i) },
                        ],
                    }),
                    r = function (a) {
                    ...
                    t = b.removal({
                        styles: [
                            {
                                name: l.not(
                                    l.pattern(/width|height|list-style-type/),
                                ),
                                condition: r,
                            },
                            {
                                name: l.pattern(/width|height/),
                                condition: d.isNotImage,
                            },
                        ],
                    }),
                    u = b.removal({
                        classes: [{ name: l.not(l.exact('rtf-data-image')) }],
                    }),
                    v = b.removal({
                        styles: [{ name: l.pattern(a.validStyles()) }],
                    }),
                    w = b.removal({ classes: [{ name: l.pattern(/mso/i) }] }),
                    x = b.unwrapper({
                        tags: [
                            { name: l.exact('img'), condition: d.isLocal },
                            {
                                name: l.exact('a'),
                    ...
                    B = b.unwrapper({
                        tags: [
                            {
                                name: l.pattern(a.specialInline()),
                                condition: f.not(d.hasContent),
                            },
                        ],
                    }),
                    C = b.unwrapper({
                        tags: [{ name: l.exact('p'), condition: s('li') }],
                    }),
                    D = b.transformer({
                        tags: [{ name: l.exact('p'), mutate: e.addBrTag }],
                    }),
                    E = function (a) {
                    ...
                    F = b.transformer({
                        tags: [
                            {
                                name: l.pattern(/ol|ul/),
                                mutate: e.properlyNest,
                            },
                        ],
                    }),
                    G = b.transformer({
                        tags: [
                            {
                                name: l.exact('b'),
                                mutate: f.curry(e.changeTag, 'strong'),
                            },
                            {
                                name: l.exact('i'),
                                mutate: f.curry(e.changeTag, 'em'),
                            },
                            { name: l.exact('u'), mutate: E },
                            {
                                name: l.exact('s'),
                    ...
                    H = b.removal({
                        classes: [{ name: l.exact('ephox-limbo-transform') }],
                    }),
                    I = (function () {
                        var a = /^file:\/\/\/[^#]+(#[^#]+)$/,
                            c = function (b) {
                            ...
                            d = function (b) {
                                var c = k.get(b, 'href');
                                k.set(b, 'href', c.replace(a, '$1'));
                            };
                        return b.transformer({
                            tags: [
                                { name: l.exact('a'), condition: c, mutate: d },
                            ],
                        });
                    })(),
                    J = b.removal({
                ...
                return {
                    ...
                    removeEmptyClass: A,
                    pruneInlineTags: B,
                    unwrapSingleParagraphsInlists: C,
                    addPlaceholders: D,
                    nestedListFixes: F,
                    inlineTagFixes: G,
                    cleanupFlags: H,
                    distillAnchorsFromLocalLinks: I,
                    removeLocalLinks: J,
                    removeAnchors: p,
                    none: f.noop,
                };
        ...
        g(
            '6q',
            ['g', '5k', '7k', '6s', '7n', '7o', '7p', 'o', 'k'],
            function (a, b, c, d, e, f, g, h, i) {
                var j = function (a) {
                        return (
                            a.browser.isIE() && a.browser.version.major >= 11
                        );
                    },
                    k = function (a, b, c) {
                        var d = i.fromDom(a.getNode());
                        return b(d).fold(
                            function () {
                                return [a];
                            },
                    ...
                    m = function (a, e, f) {
                        var g = f.browser.isFirefox() || f.browser.isSpartan(),
                            h = g ? b.local : b.vshape,
                            i = !g,
                            k = j(f) ? c.none : d.pipeline([l(h, i)]),
                            m = g ? c.none : c.removeLocalImages,
                            n = a ? k : c.none;
                        return { annotate: [n], local: [m] };
                    },
                    n = function (a, b) {
                        var d = j(b) && a;
                    ...
                    r = function (b, d, e) {
                        ...
                        return a.flatten([
                            ...
                            o(b, d, e),
                            [
                                c.distillAnchorsFromLocalLinks,
                                c.removeLocalLinks,
                                c.removeVacantLinks,
                            ],
                            [c.removeEmptyStyle],
        ...
        g('98', ['g', 'o', 'p', '96', '9i'], function (a, b, c, d, e) {
            var f = function (b) {
                    return a.foldr(
                        b,
                        function (a, b) {
        ...
        g('9a', ['9k', '9l', '9m', '9n'], function (a, b, c, d) {
        ...
        g('a5', ['96', 'a3', '98', '9a'], function (a, b, c, d) {
        ...
        g('9g', ['g', '9t', '9u', '9i', '9y'], function (a, b, c, d, e) {
        ...
        g('9h', ['g', 'o', '9t', '9z', 'a0'], function (a, b, c, d, e) {
        ...
        g('a7', ['g'], function (a) {
            var b = function (b, c) {
                ...
                var d = a.foldl(
                    ...
                    e = c[c.length - 1];
                return e < b.length
                    ? d.values.concat(b.substring(e))
                    : d.values;
            };
            return { splits: b };
        }),
        g('a1', ['a6', 'a7'], function (a, b) {
            var c = function (a, c) {
                    return b.splits(a, c);
                },
                d = function (b) {
        ...
        g('9j', ['g', 'p', '96', '9a', 'a1'], function (a, b, c, d, e) {
            var f = function (f, g, h) {
                ...
                return (
                    f.insert().afterAll(g, l),
                    [c.range(g, 0, j[0].length)].concat(k)
                );
            };
            return { subdivide: f };
        }),
        g('99', ['g', 'o', '9j', '9a'], function (a, b, c, d) {
            var e = function (e, f, g) {
        ...
        g('8d', ['o', 'p', '8a', '8b'], function (a, b, c, d) {
            var e = function (c) {
        ...
        g('7r', ['8a', '8b', '8c', '8d'], function (a, b, c, d) {
            var e = function (a) {
                    return c.word(a);
                },
                f = function (a) {
        ...
        g('9p', ['g', '1r', '9o', '17'], function (a, b, c, d) {
            var e = function (a) {
        ...
        g('7s', ['55'], function (a) {
            ...
            return { tokens: d, link: b, autolink: c };
        }),
        g('25', ['26'], function (a) {
            var b = function (b) {
                    return a.first(b).isSome();
        ...
        g(
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                var p = e.link().source,
                    ...
                    r = 9,
                    s = function (a) {
                        var b = f.immutable('word', 'pattern'),
                            e = d.unsafetoken(p),
                            g = b('__INTERNAL__', e);
                        return c.run(a, [g]);
                    },
                    t = function (a) {
                        return !m.closest(a, 'a');
                    },
                    u = function (a) {
                        return b
                            .from(a[0])
                    ...
                    y = function (b) {
                        ...
                        if (c.length > 0) {
                            var d = o.prevSiblings(c[0]),
                                e = i.fromTag('ul');
                            if ((j.before(b[0], e), d.length > 0)) {
                                var f = i.fromTag('li');
                                j.append(e, f), k.append(f, d);
                            }
                            k.append(e, c);
                        }
                    };
                ...
                var j = e.detect(),
                    k = function (a, b, c, d) {
                        try {
                            ...
                            return (
                                i.error(m),
                                g.error('errors.paste.process.failure')
                            );
                        }
                    },
        ...
        g('5d', ['6o', 'g', 'n', 'p', '24', '3q'], function (a, b, c, d, e, f) {
        ...
        g('6p', ['g', 'k', '6n', '7t'], function (a, b, c, d) {
            var e = function (a) {
                    var e = b.fromTag('div');
                    ...
                    n = function (b) {
                        return a.sync(function (f) {
                            var g = d.isValidData(b) ? k : l,
                                h = g(b).filter(j).fold(e.cancel, m);
        ...
        g('7u', ['8e', '7v', '8f', 'p', '2n'], function (a, b, c, d, e) {
            var f = function (a, b) {
                    ...
                    var l = function (a, d, e) {
                        var l = function (b) {
                            ...
                            n = function () {
                                var h = c.find(a);
                                b.each(h, f.remove),
                                    j.trigger.insert(g.children(a), d, e);
                            },
                            o = function (a) {
                                m(a.message());
                            };
                        if (
                            i.allowLocalImages === !0 &&
                            i.enableFlashImport === !0
                        ) {
                            var p = h(i);
        ...
        g(
            ...
            function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
                var o = l.immutable('data', 'rtf'),
                    ...
                    w = function (a, b) {
                        if (!a.isSupported()) return k.none();
                        var d = b.clipboardData;
                        return c.isValidData(d)
                            ? c.getFlavor(d.types, t).bind(function (a) {
                                  var c = d.getData(a.type);
                                  return v(c) ? k.some(o(c, C(b))) : k.none();
                              })
                            : k.none();
                    },
                    x = function (a) {
                    ...
                    y = function (a) {
                        if (p.browser.isIE() || p.browser.isFirefox())
                            return k.none();
                        if (c.isValidData(a.clipboardData)) {
                            var b = a.clipboardData;
                            return c
                                .getPreferredFlavor(s, b.types)
                                .map(function (a) {
                                    return b.items;
                                });
                        }
                    ...
                    z = function (a, b) {
                        var d = c.isValidData(b.clipboardData)
                            ? b.clipboardData.types
                            : [];
                        return c
                            .getFlavor(d, a.clipboardType())
                            .map(function (a) {
                                return o(b, k.none());
                            });
                    },
            ...
            function (a, b, c, d, e, f, g) {
                var h = function () {
                    ...
                    k = function (b) {
                        ...
                        d.add(c, a.resolve('flashbin-helpcopy'));
                        var f = e.fromHtml(
                            '<p>' + b('cement.dialog.flash.missing') + '</p>',
                        );
        ...
        g('5q', ['1h', 'g', '5u', '5w'], function (a, b, c, d) {
            return function (e, f, g) {
                var h = function (c) {
        ...
        g('6z', ['78'], function (a) {
            var b = function (a, b) {
                    return (
                        (void 0 !== a[b] && null !== a[b]) || (a[b] = {}), a[b]
                    );
                },
                c = function (c, d) {
                    for (
                        var e = d || a, f = c.split('.'), g = 0;
                        g < f.length;
                        ++g
                    )
                        e = b(e, f[g]);
        ...
        g('5r', ['6z'], function (a) {
            var b = function (b) {
                ...
                return (
                    (c.ephemeral = h), (c.permanent = i), (c.unregister = j), c
                );
            };
            return { install: b };
        }),
            ...
            function (
                ...
                return function (g) {
                            ...
                            if ((N.stop(), !j)) {
                                ...
                                try {
                                    ...
                                    e.each(J, function (b, c) {
                                        ...
                                        if (void 0 === d)
                                            throw (
                                                'Flash object does not have the method "' +
                                                c +
                                                '"'
                                            );
                                        d.call(a, b);
                                    ...
                                    u.log(
                                        'Flash dialog - Error during load: ',
                                        b,
                                    );
                                }
                            }
                    ...
                    var O = function () {
                        ...
                        P = function () {
                            A.browser.isFirefox() &&
                                y.getSelection().removeAllRanges(),
                                q.focus(L);
                        },
                        Q = null,
                        R = function () {
        ...
        g('71', ['3y', 'k', '3q'], function (a, b, c) {
            ...
            return { after: f, commonAncestorContainer: e };
        }),
        g('70', ['5y', '71', 'k', '3q'], function (a, b, c, d) {
            var e = function (a) {
                    return b.after(
                ...
                h = function (a, b, c, e) {
                    return function (f) {
                        if (f.extend)
                            f.collapse(a.dom(), b), f.extend(c.dom(), e);
                        else {
        ...
        g('62', ['5y', '70', 'p', '71', 'k'], function (a, b, c, d, e) {
            var f = function (b, d) {
        ...
        g('72', ['g', '5y', '5z', '10'], function (a, b, c, d) {
            var e = function (b, e) {
                    var f = d.name(b);
                    return 'input' === f
                        ? c.after(b)
        ...
        g('3m', ['64', 'k', '23', '24', '3q'], function (a, b, c, d, e) {
            return function (f) {
                var g = b.fromTag('br'),
                    h = function (a, b) {
                        a.dom().focus();
        ...
        g(
            ...
            function (a, b, c, d, e, f, g, h) {
                var i = a.detect(),
                    ...
                    k = function (a) {
                        var b =
                            i.browser.isIE() && 'body' !== h.name(a) ? f : e;
                        return b(j);
                    };
                return function (a) {
        ...
        g('68', ['z', 'k', '1m'], function (a, b, c) {
            var d = function (d) {
                if (
                    'complete' === c.readyState ||
                    'interactive' === c.readyState
                )
                    d();
                else
                    var e = a.bind(
                              ...
                              var d = i.bind(c, 'load', function () {
                                  var g = function (a) {
                                          var c =
                                              q.isSafari() &&
                                              p.os.isOSX() &&
                                              10 === p.os.version.major &&
                                              p.os.version.minor < 12;
                                          (o = e.some(a)),
                                              q.isSpartan() || c || m.remove(b);
                                      },
                                      h = n.ephemeral(g),
                                      i = a + '/wordimport.js';
                                  f.write(
                    ...
                    k = function () {
                        if (e.any(i)) {
                            var a = f
                                    .first('head')
                                    .getOrDie(
                                        'Head element could not be found.',
                                    ),
                                b = f
                                    .descendant(a, i)
                                    .getOrDie(
                                        'The style element could not be removed',
                                    );
                            d.remove(b);
                        }
                    };
        ...
        g('u', ['o'], function (a) {
            ...
            return {
                ...
                unmark: e,
                isMarked: f,
                retainContentEditable: g,
                restoreContentEditable: h,
                internalHtmlMime: a.constant(b),
            };
        }),
        g('s', ['27', 'u'], function (a, b) {
            var c = function () {},
                d = function (b) {
                    return (
                        a.iOS === !1 &&
                ...
                f = function (a, b, c, d) {
                    e(a.clipboardData, b.html, b.text)
                        ? (a.preventDefault(), d())
                        : c(b.html, d);
                },
                g = function (a) {
                    return function (b, c) {
                        var d = a.dom.create('div', {
                        ...
                        a.dom.setStyles(d, {
                            ...
                            d.appendChild(e),
                            a.dom.add(a.getBody(), d);
                        var f = a.selection.getRng();
                        e.focus();
                        var g = a.dom.createRng();
                ...
                h = function (a) {
                    var c = b.retainContentEditable(
                        a.selection.getContent({ contextual: !0 }),
                    );
                    return {
                        html: b.mark(c),
                ...
                j = function (a) {
                    return function (b) {
                        a.selection.isCollapsed() === !1 && f(b, h(a), g(a), c);
                    };
                },
                k = function (a) {
                    a.on('cut', i(a)), a.on('copy', j(a));
                };
            return { register: k };
        }),
        g('x', ['g', 'k', 'j', '1m'], function (a, b, c, d) {
            var e = function (a) {
                ...
                f = function (d) {
                    a.each(
                        a.map(d.getElementsByTagName('*'), b.fromDom),
                        function (a) {
        ...
        g('w', ['g', 'p', '2a', '2b'], function (a, b, c, d) {
            var e = function (a) {
            ...
            var b = function (a, b) {
                ...
                d = function (a, b, c) {
                    var d = a.dom.add(
                        ...
                        e = a.fire('PastePostProcess', { internal: c, node: d })
                            .node.innerHTML;
                    return a.dom.remove(d), e;
                },
                e = function (a, d, e) {
                    return b(a, 'PastePreProcess') ? c(a, d, e) : d;
                },
                f = function (a, c, e) {
                    return b(a, 'PastePostProcess') ? d(a, c, e) : c;
                },
                g = function (b, c, d) {
                    var g = a.unmark(c);
                    return f(b, e(b, g, d), d);
                },
                h = function (a) {
                    return a.plugins.powerpaste;
                },
                i = function (a) {
                    var b = a.settings;
                    b.paste_preprocess &&
                        a.on('PastePreProcess', function (c) {
                            b.paste_preprocess.call(a, h(a), c);
                        }),
                        b.paste_postprocess &&
                            a.on('PastePostProcess', function (c) {
                                b.paste_postprocess.call(a, h(a), c);
                            });
                };
            return { process: g, registerEvents: i };
        }),
        g(
            '6',
            [
            ...
            function (
                ...
                return function (x, y, z, A, B) {
                    var C, D, E, F, G;
                    (G = (A ? A.jsUrl : z) + '/js'),
                        (E = (A ? A.swfUrl : z) + '/flash/textboxpaste.swf'),
                        (F = (A ? A.imgUrl : z) + '/img/spinner_96.gif');
                    var H = function (a) {
                        ...
                        J = function (a, b, c) {
                            var d = H(a)
                                ? [n.linkSelection, n.insertImage]
                                : [];
                            n.until(a, b, d.concat([I(c)]));
                        },
                        K = function () {
                            D && x.selection.moveToBookmark(D), (D = null);
                        };
                    x.on('init', function (n) {
                        i.injectStyles(F);
                        var w = {
                                baseUrl: G,
                                swf: E,
                                officeStyles:
                                    x.settings.powerpaste_word_import ||
                                    h.officeStyles,
                                htmlStyles:
                                    x.settings.powerpaste_html_import ||
                                    h.htmlStyles,
                                translations: g.translate,
                                allowLocalImages:
                                    x.settings.powerpaste_allow_local_images !==
                                    !1,
                                enableFlashImport:
                                    x.settings
                                        .powerpaste_enable_flash_import !== !1,
                                intraFlag: {
                                    clipboardType: l.internalHtmlMime,
                                    findClipboardTags: function (a, b) {
                                        var d = c.filter(a, function (a) {
                                            return (
                                                t.isComment(a) &&
                                                u.contains(
                                                    q.get(a),
                                        ...
                                        return d.length ? f.some(d) : f.none();
                                    },
                                },
                                    ...
                                    a.events.insert.bind(function (a) {
                                        var b = c
                                                .map(
                                                    a.elements(),
                                                    function (a) {
                                                        return p.nodeToString(
                                                            a.dom(),
                                                        );
                                                    },
                                                )
                                                .join(''),
                                            d = l.restoreContentEditable(b);
                                        B.importImages(a.assets()),
                                            x.focus(),
                                            v(function () {
                                                K(),
                                                    J(
                                                    ...
                                                    B.uploadImages(a.assets());
                                            }, 1);
                                    });
                            },
                            I = a(A, z.createDialog, e.noop, w),
                            L = b();
                        c.each([I, L], H),
                            (C = r.bind(A, 'paste', function (a) {
                                D || (D = x.selection.getBookmark());
                                var b = y.isText() ? L : I;
                                b.paste(a.raw()),
                                    y.reset(),
                                    v(function () {
                                        x.windowManager.windows[0] &&
                        ...
                        x.on('remove', function (a) {
                            1 === w.editors.length && i.removeStyles(),
                                C.unbind();
                        });
                };
            },
        ),
        g('7', ['13', '14'], function (a, b) {
            var c = function (a) {
                return (
                    tinymce.util.VK.metaKeyPressed(a) &&
                    86 == a.keyCode &&
                    a.shiftKey
                );
            };
                ...
                var g = a(function () {
                    ...
                    h = function () {
                        ...
                        a.active(b),
                            ...
                            b === !0 &&
                                0 != d.settings.paste_plaintext_inform &&
                                g(),
                            d.focus();
                    },
                    i = function () {
